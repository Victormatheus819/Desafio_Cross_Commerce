defmodule DesafioCrossCommerce.StoreTest do
  use DesafioCrossCommerce.DataCase

  alias DesafioCrossCommerce.Store

  describe "books" do
    alias DesafioCrossCommerce.Store.Book

    import DesafioCrossCommerce.StoreFixtures
